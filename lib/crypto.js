...
module.exports = {
   ...
   */
  deriveAddress: function(seed, index, curve = "ed25519", hashAlgo = "sha256") {
    const { publicKey } = this.deriveKeyPair(seed, index, curve)
    ...
    hashedPublicKey = this.hash(publicKey,hashAlgo)
  ...
  deriveKeyPair(seed, index, curve = "ed25519") {
    ...
    const software_id_buf = Uint8Array.from([1])
