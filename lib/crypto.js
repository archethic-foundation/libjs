...
import { isHex, hexToUint8Array, concatUint8Arrays, encodeInt32, maybeHexToUint8Array, maybeStringToUint8Array } from './utils.js';
...
function deriveSecret(sharedKey) {
  sharedKey = maybeHexToUint8Array(sharedKey)
