...
module.exports = {
    ...
    hash: function(content, algo = "sha256") {
        ...
        if (typeof(content) !== "string" && !Buffer.isBuffer(content)) {
            throw "Content must be a string or Buffer"
        }
     ...
     * @param {String | ArrayBuffer} privateKey Private key to use to sign the data
     */
    sign(data, privateKey) {
        ...
        if (typeof(privateKey) !== "string" && !Buffer.isBuffer(privateKey)) {
            throw "PrivateKey must be a string or Buffer"
        }
     ...
     * @param {String | ArrayBuffer} publicKey Public key for the shared secret encryption
     */
    encrypt: function (data, publicKey) {
        ...
        if (typeof(publicKey) !== "string" && !Buffer.isBuffer(publicKey)) {
            throw "PublicKey must be a string or Buffer"
        }
    ...
    deriveSecret: function(sharedKey) {
        ...
        if (typeof(sharedKey) !== "string" && !Buffer.isBuffer(sharedKey)) {
            throw "SharedKey must be a string or Buffer"
        }
