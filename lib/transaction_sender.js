...
module.exports = class TransactionSender {
  ...
  async send(tx, endpoint, confirmationThreshold = 100, timeout = 60) {
    ...
    try {
      this.confirmationNotifier = await waitConfirmations(txAddress, this.absintheSocket, handleConfirmation.bind(this))
...
function handleConfirmation(nbConfirmations, maxConfirmations) {
