...
module.exports = {
  ...
  waitConfirmations: function (address, endpoint, handler) {
    ...
    return new Promise((resolve, reject) => {
      withAbsintheSocket.observe(absintheSocket, notifier, {
        onStart: function () {
          resolve({ absintheSocket, notifier })
        },
        ...
        onResult: function (result) {
          if (result.data.transactionConfirmed) {
            ...
            // Cancel the subscription 1 minute after the first confirmation
            setTimeout(() => withAbsintheSocket.cancel(absintheSocket, notifier), 60_000)
  ...
  cancelSubscription: async function ({ absintheSocket: absintheSocket, notifier: notifier }) {
    withAbsintheSocket.cancel(absintheSocket, notifier)
  },
