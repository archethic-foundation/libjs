...
/**
 * If given value is a Uint8Array, return it. If it's a hexadecimal string, convert it to a Uint8Array
 * @param {Uint8Array | String} value 
 * @throws {String} If value is neither a hexadecimal string nor Uint8Array
 */
export function maybeHexToUint8Array(value) {
  if (typeof (value) !== "string" && !(value instanceof Uint8Array)) {
    throw "Value must be a string or Uint8Array"
  }

  if (typeof (value) == "string") {
    if (!isHex(value)) {
      throw "Value must be an hexadecimal string"
    }
...
/**
 * If given value is a Uint8Array, return it. If it's a string, convert it to a Uint8Array
 * @param {Uint8Array | String} value 
 * @throws {String} If value is neither a string nor Uint8Array
 */
export function maybeStringToUint8Array(value) {
  if (typeof (value) !== "string" && !(value instanceof Uint8Array)) {
    throw "'value' must be a string or Uint8Array"
  }
...
/**
 * If given value is a hexadecimal string, return it. If it's a Uint8Array, convert it to a string
 * @param {Uint8Array|String} value 
 * @throws {String} If value is neither a hexadecimal string nor Uint8Array
 */
export function maybeUint8ArrayToHex(value) {
  if (typeof value !== "string" && !(value instanceof Uint8Array)) {
    throw "Value must be a string or Uint8Array"
  }
