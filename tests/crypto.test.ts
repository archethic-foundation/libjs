...
describe("crypto", () => {
    ...
    describe("hash", () => {
        ...
        it("should generate a sha512 hash with an algo id at the begining", () => {
            ...
            expect(hashValue).toBe("01c09b378f954c39f8e3c2cc4ed9108937c6e6dbfa9f754a344bd395d2ba55aba9f071987a2c014f9c54d47931b243088aa2dd6c6d90ec92a67f8a9dfdd83eba58");
        });
        ...
        it("should generate a sha3-512 hash with an algo id at the begining", () => {
            ...
            expect(hashValue).toBe("03f64fe5d472619d235212f843c1ed8ae43598c3a5973eead66d70f88f147a0aaabcbcdc6aed160b0ae5cdf5d48871602827b242c479f999647c377698cb8b7d4f");
        });
        ...
        it("should generate a blake2b hash with an algo id at the begining", () => {
            ...
            expect(hashValue).toBe("04f4101890104371a4d673ed717e824c80634edf3cb39e3eeff555049c0a025e5f13a6aa938c7501a98471cad9c13870c13e8691e97229e4a4b4e1930221c02ab8");
        });
    });
    ...
    describe("deriveKeyPair", () => {
        it("should generate an EC keypair using Ed25519 curve", () => {
            ...
            expect(uint8ArrayToHex(keypair.publicKey)).toBe("000161d6cd8da68207bd01198909c139c130a3df3a8bd20f4bacb123c46354ccd52c");
        });

        it("should generate an EC keypair using P256 curve", () => {
            const keypair = deriveKeyPair("seed", 0, Curve.P256)
            expect(uint8ArrayToHex(keypair.publicKey)).toBe("0101044d91a0a1a7cf06a2902d3842f82d2791bcbf3ee6f6dc8de0f90e53e9991c3cb33684b7b9e66f26e7c9f5302f73c69897be5f301de9a63521a08ac4ef34c18728");
        });

        it("should generate an EC keypair using secp256k1 curve", () => {
            const keypair = deriveKeyPair("seed", 0, Curve.secp256k1)
            expect(uint8ArrayToHex(keypair.publicKey)).toBe("0201044d02d071e7e24348fc24951bded20c08409b075c7956348fef89e118370f382cf99c064b17ad950aaeb1ae04971afdc6a44d68e731b8d0a01a8f56eade92875a");
        });
