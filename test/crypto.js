import { hash, sign, deriveKeyPair, aesEncrypt, aesDecrypt, ecEncrypt, ecDecrypt, verify, generateDeterministicKeyPair } from "../lib/crypto.js"
...
describe("Crypto", () => {
  ...
  describe("ecDecrypt", () => {
    it("should decrypt data computed elsewhere", () => {
      const { privateKey } = generateDeterministicKeyPair("seed2", "ed25519", 1)
      const encrypted = "57CA61FBE7E4E965DD9658B6B2260B4FBE8788D3ED3B163994996D9F73AE7C055B5029CF5396639FBD9C51A9BCECA16FBF02558CC1"
      assert.deepStrictEqual(ecDecrypt(encrypted, privateKey), new TextEncoder().encode("hello"))
    })
  })
  ...
  describe("aesDecrypt", () => {
    it("should decrypt a data computed elsewhere", () => {
      const key = "28A7A5C8F966DF3A6F8E686466FAF7EC8CBB53AB9DE331B174C50E5A08CD5CF5"
      const encryptedData = "9236523E1EAB0611836FEA53EFD66AF977BDBB6FC81F157A4B4BC2BB4E9B1F50F7"

      assert.deepStrictEqual(aesDecrypt(encryptedData, key), new TextEncoder().encode("hello"))
    })
  })
